        ...
        <div className="">
            <div className="flex flex-col md:flex-row gap-3 items-center w-full">
                ...
                <div className="flex items-center gap-x-2">
                    <div onClick={onSave} className="flex gap-x-2 cursor-pointer p-3 md:p-4 rounded-full outline outline-1 bg-secondary outline-secondary">
                        <img src="/tick-icon.svg" className="w-3 h-3 md:w-[14px] md:h-[14px]" alt="Save" />
