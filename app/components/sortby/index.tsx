        ...
        <div className="flex items-center gap-2">
            <div className="flex flex-col justify-center items-end">
                ...
                <div className="flex gap-x-1 items-center">
                    <p className="text-sm text-primary font-semibold">{queryName}</p>
                    <div className="flex flex-col gap-y-0.5 cursor-pointer" onClick={() => {}}>
                        <img src={isAscending ? "/sort-up-icon.svg" : "/sort-up-icon-active.svg"} className="w-2 h-2"/>
                        <img src={isAscending ? "/sort-down-icon-active.svg": "/sort-down-icon.svg"} className="w-2 h-2"/>
                    </div>
                </div>
            </div>
